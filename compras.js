...
for (let i=0; i < carts.length; i++){
	carts[i].addEventListener('click', () =>{
		...
		/*console.log(carts[i].id); /*id del elemento seleccionado, el cual contiene la ubicacion*/
		UbicaProducto = carts[i].id.replace('Prod', ''); /*ubicacion del elemento en la base de datos*/
		UbicaProducto = parseInt(UbicaProducto); /*el string a numerito a entero*/
	
		/*console.log(products[UbicaProducto])/* Producto al que se le hizo click*/
...
<table width="800" cellspacing="0" cellpadding="0" style="border-bottom:1pt solid black;">
  <tr>
     <div class="product">
         ...
         <th><img src="./images/Productos/${item.tag}.png" width="80"></th>
	 </div>
     <div class="namee">
